...
import { GeneratedBook, PdfConfig, PdfFontFamily } from '../types/book';
...
export async function buildBookPdf(book: GeneratedBook, userConfig: Partial<PdfConfig> = {}): Promise<Uint8Array> {
